...
class Job:
    ...
    def __str__(self):
        return "name: "+self.get_name()+" time needed: "+str(self.get_time_needed())+" time elapsed: "+str(self.get_time_elapsed())
...
class Company:
    ...
    def elapsed_time(self, no_of_mins):
        completed_jobs=[]
        for emp in self.__employees:
            jobdone=emp.elapsed_time(no_of_mins)
            if jobdone != None:
                completed_jobs.append(jobdone)
